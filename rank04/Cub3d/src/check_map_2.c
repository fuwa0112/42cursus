...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/25 22:46:46 by thitoe            #+#    #+#             */
/*   Updated: 2026/02/25 22:46:47 by thitoe           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../inc/cub3d.h"

static void	bad_map_2(t_cub3d *data, int len, int max_len, int y)
{
	char	*new_line;
